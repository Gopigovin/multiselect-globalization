...
window.sfBlazor.Schedule = function () {
  ...
  function () {
    ...
    InlineEdit.prototype.inlineEdit = function (clickType, isTemplate, guid, setFocus) {
      if (guid === void 0) {
        guid = null;
      }
  ...
  function () {
    ...
    SfSchedule.prototype.inlineEdit = function (clickType, isTemplate, guid, setFocus) {
      if (guid === void 0) {
        guid = null;
      }

      this.inlineModule.inlineEdit(clickType, isTemplate, guid, setFocus);
    };
  ...
  var Schedule = {
    ...
    inlineEdit: function inlineEdit(element, clickType, isTemplate, guid, setFocus) {
      if (guid === void 0) {
        guid = null;
      }

      if (element && element.blazor__instance) {
        element.blazor__instance.inlineEdit(clickType, isTemplate, guid, setFocus);
      }
    },
