  ...
  function () {
    ...
    */
    ...
    TaskbarEdit.prototype.ganttChartMouseUp = function (e) {
      ...
      if (this.falseLine) {
        for (var i = 0; i < this.chartBodyContainer.querySelectorAll('.' + falseLine).length; i++) {
          this.chartBodyContainer.querySelectorAll('.' + falseLine)[0].remove();
        }
      }
    };
    ...
    TaskbarEdit.prototype.drawFalseLine = function () {
      ...
      if (this.taskBarEditAction === 'ConnectorPointLeftDrag') {
        left = this.elementOffsetLeft - this.connectorPointWidth / 2 - this.parent.chartScrollModule.previousScroll.left;
      }

      if (this.taskBarEditAction === 'ConnectorPointRightDrag') {
        left = this.elementOffsetLeft + this.elementOffsetWidth + this.connectorPointWidth / 2 - this.parent.chartScrollModule.previousScroll.left;
      }

      var top = this.elementOffsetTop + this.elementOffsetHeight / 2 + this.chartBodyContainer.offsetTop - this.parent.chartScrollModule.previousScroll.top;
