...
window.sf.officechart = function (exports) {
  ...
  function () {
    ...
    ChartComponent.prototype.checkAndSetAxisValue = function (primaryYAxis, data) {
      if (!sf.base.isNullOrUndefined(data.minimumValue)) {
        primaryYAxis.minimum = data.minimumValue;
      }

      if (!sf.base.isNullOrUndefined(data.maximumValue) && data.maximumValue !== 0) {
        primaryYAxis.maximum = data.maximumValue;
      }

      if (!sf.base.isNullOrUndefined(data.majorUnit) && data.majorUnit !== 0) {
