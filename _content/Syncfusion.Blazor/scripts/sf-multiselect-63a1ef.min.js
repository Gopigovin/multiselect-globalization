                ...
                var SfMultiSelect =
                    ...
                    function () {
                        ...
                        SfMultiSelect.prototype.updateRemainElement = function (raminElement, viewContainer, remaining, totalWidth) {
                            ...
                            this.dotNetRef.invokeMethodAsync('RemainCount', remaining).then((remainCount) => {
                                var remainTemp = this.options.overFlowContent.replace('${count}', remainCount);
                                var totalTemp = this.options.totalCountContent.replace('${count}', remainCount);
